...
export async function verifyOTP(email, code) {
  ...
  console.log("Code entered:", normalizedCode);
  ...
  console.log("OTP record found:", otp);
  ...
  if (!otp) {
    ...
    if (anyOtp) {
      console.log("Found OTP for email but code doesn't match:", anyOtp.code);
      return {
        valid: false,
  ...
  console.log("Expiry check - Now:", now, "Expires at:", expiresAt);
